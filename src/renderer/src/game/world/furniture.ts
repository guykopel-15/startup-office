...
const LAYOUT: Readonly<Record<RoomKey, readonly LocalPiece[]>> = {
  ...
  [RoomKey.Product]: [bigDesk(4, 4.5, { hasPaper: true }), desk(9.5, 9.5, { screen: ScreenColor.Mint }), desk(3, 9.5), box(FurnitureKind.Bookshelf, 0.7, 2, 1.7, 4.5), plant(12.5, 1.3)],
  [RoomKey.Lobby]: [box(FurnitureKind.WaterCooler, 45.6, 1.9, 1.1, 1.1), plant(1.2, 1.9), box(FurnitureKind.Sofa, 20, 1.4, 5, 1.6)],
  [RoomKey.Marketing]: [desk(2, 3.5, { hasMug: true }), desk(7, 3.5), desk(4.5, 9.5, { hasPaper: true }), desk(8.5, 9.5), plant(0.8, 12.8)],
  [RoomKey.Sales]: [desk(2, 3.5, { screen: ScreenColor.Mint, hasLamp: true }), desk(7, 9.5, { hasMug: true }), desk(7, 3.5), desk(2, 9.5), plant(9.8, 2)],
  [RoomKey.Finance]: [desk(2, 3.5, { hasPaper: true }), desk(7, 9.5), desk(7, 3.5), desk(2, 9.5), box(FurnitureKind.FilingCabinet, 9.4, 1.2, 1.6, 1.4), box(FurnitureKind.Safe, 1, 12, 1.8, 1.6)],
  [RoomKey.Operations]: [
